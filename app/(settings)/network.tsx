...
const Page = () => {
    ...
    const options = [
        {
            title: 'Mainnet',
            desc: 'https://fullnode.mainnet.aptoslab.com/v1',
        },
        {
            title: 'Testnet',
            desc: 'https://fullnode.testnet.aptoslab.com/v1',
        },
        {
            title: 'Devnet',
            desc: 'https://fullnode.devnet.aptoslab.com/v1',
        },
    ];
    ...
    useEffect(() => {
        const idx = options.findIndex((item) => item.title.toLowerCase() == network);
